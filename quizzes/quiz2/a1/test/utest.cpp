...
//     cars->sortedByOdometry();

//     vector<pair<double, int> > sortedManually; // Creating vector of pairs

//     for (int i = 0; i < cars.size(); i++)
//       sortedManually.push_back(std::make_pair((cars.at(i))->getOdometry(), (cars.at(i))->getID()));

//     std::sort(sortedManually.begin(), sortedManually.end());

//     EXPECT_EQ((sortedByOdometry.at(0)).first, (sortedByOdometry.at(0)).first);
//     EXPECT_EQ((sortedByOdometry.at(1)).first, (sortedByOdometry.at(1)).first);
//     EXPECT_EQ((sortedByOdometry.at(2)).first, (sortedByOdometry.at(2)).first);

//     EXPECT_EQ((sortedByOdometry.at(0)).second, (sortedByOdometry.at(0)).second);
//     EXPECT_EQ((sortedByOdometry.at(1)).second, (sortedByOdometry.at(1)).second);
//     EXPECT_EQ((sortedByOdometry.at(2)).second, (sortedByOdometry.at(2)).second);
// }
