...
//     // ADDED
//     // pfms::geometry_msgs::Point goal2{-20,-1};
...
//     // {
//     //     pfms::nav_msgs::Odometry odo = controllers.at(0)->getOdometry();
//     //     double distance = pow ( pow(odo.position.x-goal2.x,2) + pow(odo.position.y-goal2.y,2),0.5);
//     //     std::cout << "Distance to goal:" << distance << std::endl;
//     //     ASSERT_NEAR(distance,0,0.5);
//     // }
...
TEST(MissionTest, 1stTest) {
    ...
    std::vector<pfms::geometry_msgs::Point*> goals;
    pfms::geometry_msgs::Point goal0{ 10, -2};
    pfms::geometry_msgs::Point goal1{ 10,  6};
    ...
    // {
    //     pfms::nav_msgs::Odometry odo = controllers.at(0)->getOdometry();
    //     double distance = pow ( pow(odo.position.x-goal6.x,2) + pow(odo.position.y-goal6.y,2),0.5);
    //     std::cout << "Distance to goal:" << distance << std::endl;
    //     ASSERT_NEAR(distance,0,0.5);
    // }
