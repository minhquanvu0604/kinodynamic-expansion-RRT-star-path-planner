...
std::pair<double, double> turningCentre(double ini_x, double ini_y, double goal_x, double goal_y, double yaw){
    ...
    std::tuple<double, double, double> bisector = perpendicularBisector(ini_x, ini_y, goal_x, goal_y);

    std::tuple<double, double, double> heading = headingLine(ini_x, ini_y, yaw);

    std::tuple<double, double, double> line = lineFromPointAndPerpendicularLine(ini_x, ini_y, heading);
...
double turnDirection(double current_x, double current_y, double current_yaw,
