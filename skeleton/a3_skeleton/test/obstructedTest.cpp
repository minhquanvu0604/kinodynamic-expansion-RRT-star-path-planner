...
TEST(Obstructed,Obstructed1){
    ...
    path += "/test/bag/";
    std::string file = path + "obstructed1.bag";
...
TEST(Obstructed,Obstructed2){
    ...
    // Now we have the path, the images for our testing are stored in a subfolder /test/samples
    path += "/test/bag/";
    std::string file = path + "obstructed2.bag";
    ...
    Point currentGoal(56.748913,9.896706);
...
TEST(Obstructed,Obstructed3){
    ...
    // Now we have the path, the images for our testing are stored in a subfolder /test/samples
    path += "/test/bag/";
    std::string file = path + "obstructed3.bag";
    ...
    Point currentGoal(75.062973,-36.107613);
    bool inPath = process.pointInConvexPolygon(hull, currentGoal);
