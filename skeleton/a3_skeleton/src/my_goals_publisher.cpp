...
int main(int argc, char **argv)
{
    ...
    std::string default_filename = path + "ACKERMAN.TXT";
    ...
    // std::cout << "Sending them: " << std::endl;
    // for(auto goal:goals){
    ...
    //Publish goals
    ros::Publisher goal_pub = n.advertise<geometry_msgs::PoseArray>("/orange/goals", 1000,true);
    //Publishing markers
